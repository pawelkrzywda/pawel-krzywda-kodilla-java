...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://pawelkrzywda.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("paw.krzywda@gmail.com");
        driverTrello.findElement(By.id("login")).click();
        Thread.sleep(4000);

        driverTrello.findElement(By.id("password")).sendKeys("KodillaTest1!");
